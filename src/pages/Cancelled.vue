<template>
  <div class="max-w-4xl mx-auto rounded-lg bg-white shadow-lg p-8 select-none">
    ...
    <div v-else>
      <div v-for="service in services" class="bg-gray-100 rounded-md p-6 mb-6 shadow-sm">
        <div class="flex justify-between items-center">
          <div>
            <h2 class="text-xl text-red-700 font-semibold">{{ service.name }}</h2>
